...
fn write_template_files(
    ...
    if is_reply_pp {
        const REPLY_PP_FILES: &[(&str, &str)] = &[
            (
                "rpc_server.mjs",
                include_str!("../../../../examples/reply-post-process-polish/rpc_server.mjs"),
            ),
            (
                "preset_cache.mjs",
                include_str!("../../../../examples/reply-post-process-polish/preset_cache.mjs"),
            ),
            (
                "preset_builder.mjs",
                include_str!("../../../../examples/reply-post-process-polish/preset_builder.mjs"),
            ),
            (
                "polish_rules.mjs",
                include_str!("../../../../examples/reply-post-process-polish/polish_rules.mjs"),
            ),
            (
                "ollama_client.mjs",
                include_str!("../../../../examples/reply-post-process-polish/ollama_client.mjs"),
            ),
        ];
