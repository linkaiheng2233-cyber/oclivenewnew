...
export interface RoleData {
  ...
  slot_registry_pack?: import('@oclive/shared/lib/slotRegistry').SlotRegistryMap | null
  slot_registry_effective?: import('@oclive/shared/lib/slotRegistry').SlotRegistryMap | null
