...
export default {
  settings: {
    ...
    adult: {
      ...
      minorIdentityBlocked: 'The current user identity is explicitly marked as a minor by the role pack. Switch to an adult identity before enabling adult interaction.',
