...
export default {
  settings: {
    ...
    adult: {
      ...
      intervalHelp: 'A positive integer with no product hard limit. Timing starts after dialogue and narration are fully visible; with voice enabled it also waits for the previous beat to finish playing.',
      millisecondsUnit: 'ms',
      ...
      queueCapHelp: 'A positive integer shared by all roles and chats. Lowering it never drops existing beats; new generation pauses until usage falls below the cap. Higher values increase resource use and story-drift risk.',
      beatsUnit: 'beats',
