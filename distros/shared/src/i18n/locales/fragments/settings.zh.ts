...
export default {
  settings: {
    ...
    adult: {
      ...
      cancel: '暂不开启',
      accessTitle: '启用范围',
      accessHelp: '先控制 Chat Pro 的全局入口，再决定哪些角色可以加载成人扩展。',
      globalLabel: 'Chat Pro 全局成人功能',
      globalSummary: '总开关关闭时，所有角色都回到普通聊天；已经保存的角色开关不会丢失。',
      globalHelp: '关闭会立即中断所有当前成人互动并清除互动状态；各角色的开关选择会保留。',
      enabled: '已开启',
      disabled: '已关闭',
      rolesTitle: '角色开关',
      rolesHelp: '已为 {enabled} / {total} 个含成人扩展的角色保存启用状态。',
      rolesHint: '角色开关只决定该角色能否加载 adult_extension.json。全局开关关闭时会暂时停用，但不会清除这里的选择。',
      rolesEmptyTitle: '暂无可管理角色',
      ...
      roleSaved: '已保存',
      pacingTitle: '自动节拍',
      pacingHelp: '控制结构化角色对话与静音旁白显示完成后，下一拍文本何时继续。',
      pacingOverride: '使用全局固定间隔覆盖创作者 / AI 建议',
      pacingOverrideHelp: '关闭时优先采用角色扩展的创作者建议值或 AI 节奏；开启后所有角色和聊天都使用下方固定间隔。',
      intervalLabel: '每拍间隔（毫秒）',
      intervalHelp: '请输入 500–60000 毫秒。间隔从角色对话和旁白完整显示后开始；启用语音时还会等待上一拍播放完成。',
      intervalRangeError: '请输入 500–60000 之间的整数毫秒值。',
      millisecondsUnit: '毫秒',
      intervalCurrent: '当前生效：{value} 毫秒',
      savePacing: '保存节拍',
      queueTitle: '后台连续预生成',
      queueSectionHelp: '允许模型提前生成后续文本拍并排队；显示、语音和提交仍严格按当前聊天的顺序执行。',
      ...
      queueCapHelp: '对所有角色和聊天合计生效，可填写 1–8 拍。降低数值不会丢弃已生成内容，只会暂停新生成，直到缓存重新低于上限。数值越高，占用与剧情偏离风险越大。',
      queueCapRangeError: '请输入 1–8 之间的整数拍数。',
      beatsUnit: '拍',
      queueRecommendation: '实测建议：默认 2，8GB 显存 + 7B Q4 模型可按参与频率调到 2–4；本机深度 8 仍稳定，但会增加耗电和剧情因用户新输入而失效的概率。后台只缓存文本，不预生成语音。',
      queueCurrent: '当前上限：{value} 拍',
      saveQueue: '保存缓存',
      extensionErrorTitle: '部分成人扩展已被禁用',
      extensionErrorHelp: '受影响的角色仍可按普通模式使用。请修复或替换其 adult_extension.json 后再为它开启成人内容。',
      resetTitle: '重置成人确认与设置',
      resetHelp: '撤回已保存的成年声明，并将本机所有 R18 开关、节拍、队列选择和当前互动恢复为默认值。',
      resetMemoryNote: '已有对话与记忆记录不会被删除。',
      resetButton: '重置成年确认与 R18 设置',
      resetConfirm: '确定重置已保存的成年确认和全部本机 R18 设置吗？当前成人生成会停止，已有对话与记忆记录会保留。',
    },
    voicePanelLead:
    ...
    envRepairRun: '安全修复',
    envRepairRunning: '修复并复检中…',
    envRepairDoneToast: '安全修复与复检已完成。',
    envRepairIssuesToast: '修复完成，但仍发现 {count} 个需要处理的问题。',
    envRepairResult: '修复结果',
    envRepairSuccess: '通过',
    envRepairNeedsAttention: '仍需处理',
    envRepairCounts: '识别到 {roles} 个角色包、{plugins} 个目录插件。',
    envRepairIssues: '检测到 {count} 个问题',
    envRepairCanRetry: '可修复；请排除权限或磁盘问题后重试',
    envRepairManual: '需重装或人工处理',
    envRepairOpenReport: '打开修复报告',
