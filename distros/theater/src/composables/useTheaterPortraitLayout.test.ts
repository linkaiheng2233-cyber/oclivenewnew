...
describe('useTheaterPortraitLayout', () => {
  ...
  it('clamps width within limits', () => {
    ...
    expect(localStorage.getItem('oclive-theater-portrait-w')).toBe('640')
  ...
  it('clamps max height within limits', () => {
    ...
    expect(setTheaterPortraitMaxHeight(999)).toBe(THEATER_PORTRAIT_LIMITS.maxHeight.max)
    expect(localStorage.getItem('oclive-theater-portrait-max-h')).toBe('880')
  })
  ...
  it('reset restores defaults', () => {
    ...
    expect(localStorage.getItem('oclive-theater-portrait-w')).toBe('160')
