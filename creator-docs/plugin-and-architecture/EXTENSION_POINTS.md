...
|------|----------------|----------|--------|
| 记忆排序 / 上下文 | `MemoryRetrieval` | `BuiltinMemoryRetrieval`（`builtin_v2` 仅为读兼容 alias，无独立 V2 实现，见 D-SLOT-01） | `kernel/crates/oclive_kernel_runtime/src/domain/memory_retrieval.rs` |
