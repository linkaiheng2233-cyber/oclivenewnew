...
1. **契约**：**oclivenewnew** 发版若动到包契约或校验 crate，在 **oclive-pack-editor** 跑 `npm run contract:json-keys`，并对齐 **`HOST_RUNTIME_VERSION`**（见该仓库 [CONTRIBUTING.md](https://github.com/oclive-app/oclive-pack-editor/blob/main/CONTRIBUTING.md)）。
