...
| 产物 | 当前版本（`main`，2026-08-24） | 发版节奏 | 说明 |
|------|-------------------|----------|------|
| **桌面 Tauri**（`package.json` / `distros/desktop-tauri`） | **0.5.2** | 用户可见功能与安装包 | 变更写入 [CHANGELOG.md](../../CHANGELOG.md) `[0.5.2]` |
...
1. [CHANGELOG.md](../../CHANGELOG.md) **`[0.5.2] - 2026-08-24`** 已整理；发版日打 tag **`oclivenewnew-v0.5.2`**。
2. 桌面补丁 tag：**`oclivenewnew-v0.5.2`**；`oclive-cli` 未变更，不重复打 tag。
