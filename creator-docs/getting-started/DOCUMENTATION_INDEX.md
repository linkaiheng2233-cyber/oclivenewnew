...
| **双核双态（运行时 Stable / Experimental）** | [RFC](../rfc/RFC_OCLIVE_DUAL_CORE_DUAL_MODE.md) · [开发者指南](../dual-core/DEVELOPER_GUIDE.md) · [Method 注册表](../dual-core/METHOD_REGISTRY.md) · [Cursor 手递](../../handoff/DUAL_CORE_CURSOR_HANDOFF.md) · [速查（归档）](../../handoff/archive/DUAL_CORE_ALIGNMENT.md) |
...
| **Prompt 分层 & 状态联动**（Tier0、`build_character_status_summary`、`relation_transition`） | **[../../AGENTS.md](../../AGENTS.md)**「Prompt 注入分层 + 状态机联动」· 实现 **[../../crates/oclive_kernel_runtime/src/domain/prompt_builder.rs](../../crates/oclive_kernel_runtime/src/domain/prompt_builder.rs)** |
...
| **蓝图 `groups` 分组（架构图）** | **[ROLE_PACK_SPEC.md](../role-pack/ROLE_PACK_SPEC.md)** §2.3 · [RFC_ROLE_BLUEPRINT_V2.md（归档）](../../handoff/archive/RFC_ROLE_BLUEPRINT_V2.md) §4.5 |
...
| 报错后如何快速定位与提 issue | **[ERROR_CODES.md](ERROR_CODES.md)**（速查表）· **机器码与 JSON 唯一规范 [KERNEL_ERROR_CODE_CONVENTION.md](KERNEL_ERROR_CODE_CONVENTION.md)** · **A3 结项（归档）** [中文](../../handoff/archive/A3_CLOSURE_SUMMARY.md) / [English](../../handoff/archive/A3_CLOSURE_SUMMARY.en.md)（Sentry / 用户可见错误） |
...
| **测试输出契约、OOCP 套件、`invoke` 热路径矩阵、A1 收口摘要、插件集成测说明** | **[../testing/TEST_OUTPUT_SCHEMA.md](../testing/TEST_OUTPUT_SCHEMA.md)** · **[../testing/OOCP_TEST_SUITE.md](../testing/OOCP_TEST_SUITE.md)** · **[../testing/OVERVIEW.md](../testing/OVERVIEW.md)** · **[../../handoff/INVOKE_HOTPATH_MATRIX.md](../../handoff/INVOKE_HOTPATH_MATRIX.md)** · **[A1_CLOSURE_SUMMARY（归档）](../../handoff/archive/A1_CLOSURE_SUMMARY.md)** · **[../testing/ADAPTING_TEST_PLUGIN.md](../testing/ADAPTING_TEST_PLUGIN.md)** · **[../testing/L03_GENERATION_CANCEL.md](../testing/L03_GENERATION_CANCEL.md)** |
...
2. [../plugin-and-architecture/PLUGIN_V1.md](../plugin-and-architecture/PLUGIN_V1.md) — v2 **`slot_registry`** 与六槽门面（memory / emotion / event / prompt / llm / **agent**）  
...
4. [SIDECAR_LLM_USER_GUIDE.md](SIDECAR_LLM_USER_GUIDE.md) — **本机侧车 + BYOK**（接闭源 API 的路径；与工作室 oclive-studio 配合）  
