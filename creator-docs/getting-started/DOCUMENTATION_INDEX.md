...
| **内核工厂愿景（U–X 深化 + T 协作分发：market / registry remote / collab）** | **[KERNEL_FACTORY_VISION.md](KERNEL_FACTORY_VISION.md)**（[English](../../creator-docs-en/getting-started/KERNEL_FACTORY_VISION.md)） |
