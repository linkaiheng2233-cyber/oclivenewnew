...
| **官方 CLI 脚手架 `oclive-cli`（registry / compose / publish / TUI / watch / debug）** | **[../cli/OCLIVE_CLI_GUIDE.md](../cli/OCLIVE_CLI_GUIDE.md)** |
| **内核工厂愿景（注册表 / 编排 / 模板发布 / TUI / 持续 bench / 调试；U–X dashboard/matrix/plugin/profile）** | **[KERNEL_FACTORY_VISION.md](KERNEL_FACTORY_VISION.md)**（[English](../../creator-docs-en/getting-started/KERNEL_FACTORY_VISION.md)） |
