...
| **内核工厂愿景（5 分钟上手 / `doctor` / `--quick` / bench v2）** | **[KERNEL_FACTORY_VISION.md](KERNEL_FACTORY_VISION.md)**（[English](../../creator-docs-en/getting-started/KERNEL_FACTORY_VISION.md)） |
