...
| 报错后如何快速定位与提 issue | **[ERROR_CODES.md](ERROR_CODES.md)**（速查表）· **机器码与 JSON 唯一规范 [KERNEL_ERROR_CODE_CONVENTION.md](KERNEL_ERROR_CODE_CONVENTION.md)** · **A3 结项 [../../handoff/A3_CLOSURE_SUMMARY.md](../../handoff/A3_CLOSURE_SUMMARY.md)**（Sentry / 用户可见错误） |
