...
| **配置专家模型（卫星目录）** | [BLUEPRINT_FOLDER_LAYOUT.md](../../handoff/BLUEPRINT_FOLDER_LAYOUT.md) · ROLE_PACK_SPEC §2.6；主应用 **Ctrl+Shift+F** → 架构图页 **专家模型设施** 向导，写 `blueprint/includes/expert_routing.json`；架构图高亮被引用的 LLM 实例 |
