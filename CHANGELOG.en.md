...
- **Product-line scheduling view**: added **[handoff/PRODUCT_LINE_TASK_BUCKETS.md](handoff/PRODUCT_LINE_TASK_BUCKETS.md)** (easy batch vs medium vs large vs hard items); **[PRODUCT_AND_KERNEL_GAP_CHECKLIST.md](handoff/PRODUCT_AND_KERNEL_GAP_CHECKLIST.md) §D** and **[creator-docs/getting-started/DOCUMENTATION_INDEX.md](creator-docs/getting-started/DOCUMENTATION_INDEX.md)** quick entry link to it.
