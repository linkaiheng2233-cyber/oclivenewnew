...
#[must_use]
pub fn profiles_compatible_by_hash(
...
mod tests {
    ...
    fn vscode_forbids_agent_and_complex_emotion() {
        ...
        let active = active_summary_from_requirements(&default_requirements_for_distro_id("desktop"));
    ...
    fn same_distro_id_different_hash_is_unknown_without_summary() {
        ...
        let compat = evaluate_profile_compat(
            &caller,
            None,
            Some("desktop"),
            Some("aaa"),
