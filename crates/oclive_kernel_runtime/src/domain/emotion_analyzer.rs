...
impl EmotionAnalyzer {
    ...
    pub fn get_dominant_emotion(result: &EmotionResult) -> Emotion {
        // Note: `models::Emotion` is a small UI-oriented enum (Happy/Sad/Angry/Neutral/...)
        // while this analyzer produces 7D scores. We map:
        // - joy -> Happy
        // - sadness -> Sad
        // - anger/disgust -> Angry
        // - surprise -> Excited
        ...
        // Disgust is treated as a form of anger in the UI enum.
    ...
    pub fn calculate_intensity(result: &EmotionResult) -> f64 {
        ...
        match max_emotion {
            ...
            Emotion::Shy => result.fear, // fallback
