...
**状态**：**模式 1 已交付**；**模式 2 已解冻**（朋友 cohort 产品门通过，见 [`MODE2_UNFREEZE.md`](MODE2_UNFREEZE.md)）；模式 3 **仍冻结**。
**最后更新**：2026-06-25
...
| **模式 2** | 写**剧本大纲** + 可导入角色包 | 围绕用户大纲**自行演绎** | 中 / BYOK | **解冻 · 开发中**（`outline_rewrite`） |
| **模式 3** | 提供**角色包**（自带场景与 prompt） | 基于角色包**自由演绎** | 强模型 | 冻结（roadmap，最后做） |

> **铁律（2026-06-25 更新）**：模式 1 朋友 cohort 产品门已通过（见 [`PLAYTEST_MATRIX.md`](PLAYTEST_MATRIX.md)）；**模式 2 可开工**；模式 3 仍等模式 2 playtest 扩展。
...
> **模式 2**：产品门已通过（朋友 cohort · 2026-06-25）；RFC = [`MODE2_RFC.md`](MODE2_RFC.md)。**模式 3**：仍冻结。
...
1. **模式 2 可开工；模式 3 仍冻结。** 模式 1 朋友 cohort 产品门已通过；模式 3 等模式 2 playtest 扩展后再开计划。
