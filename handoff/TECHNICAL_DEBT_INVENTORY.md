...
**Verification (2026-07-16 · D-ROLEVER-01 → main):** 内容经 PR [#125](https://github.com/linkaiheng2233-cyber/oclivenewnew/pull/125) / merge 路径进 `origin/main` `23e4e184` · 内容锚 `601f48cf` · CI [`29500322721`](https://github.com/linkaiheng2233-cyber/oclivenewnew/actions/runs/29500322721) **硬门禁 success**（`rust` windows+ubuntu / `dimension5` / `cargo-audit` / `cli` / `oocp` / `cross-host-e2e` / `stale-paths`）· ROLE_PACK_SPEC §11 版本与迁移（中英）· **Done** · merge-main CI [`29510167890`](https://github.com/linkaiheng2233-cyber/oclivenewnew/actions/runs/29510167890) 记录时仍可能 in_progress（ubuntu rust 已 success）。
...
| **D-ROLEVER-01** | 角色包版本迁移 | **P2** | ROLE_PACK_SPEC 章节 | **Done**（2026-07-16 · SPEC §11 中英 · 经 `#126` 进 main `23e4e184` · 内容锚 `601f48cf` · CI [`29500322721`](https://github.com/linkaiheng2233-cyber/oclivenewnew/actions/runs/29500322721) · PR [#125](https://github.com/linkaiheng2233-cyber/oclivenewnew/pull/125)） |
