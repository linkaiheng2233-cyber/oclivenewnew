...
**更新日期：** 2026-07-17
**结论：** 活跃 OPEN/Partial/Observe/Deferred/冻结项均有 `long-plans/` 条目；新增 P1 `K-PLUGIN-SEC-01` Full 分阶段计划。
...
| 台账状态类 | 覆盖 | 注 |
|------------|------|-----|
| OPEN / Partial 主仓可施工 | ✓ auto 书 | K-PLUGIN-SEC-01 · T-DOC-02 · D-ROLEVER · RESILIENCE · CROSS/DIST/MARKET · VOICE-06/07 · SUPPLY-05-Full · FOLLOWUP-PR123 |
