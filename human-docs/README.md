...
| **human-docs-en 全覆盖** | **Partial** | L0–L4 摘要 + 07/08/09/10；L5/L6 仍链中文 06/07 |
...
| ID | 项 | 优先级 |
|----|-----|--------|
| H-DOC-01 | `human-docs-en/06_KERNEL_LEARNING_PATH` 英文摘要 | P2 |
| H-DOC-02 | `08_REFERENCE_MAP` §8 中 `04_4.6` 改「已归档勿作 truth」 | **Done**（本轮） |
