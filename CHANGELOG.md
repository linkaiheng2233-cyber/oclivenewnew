...
- 新增 **[creator-docs/roadmap/MARKET_LAUNCHER_INTEGRATION.md](creator-docs/roadmap/MARKET_LAUNCHER_INTEGRATION.md)**：角色包 / 插件市场与启动器联动（发版同发、静态索引、阶段 A/B/C、CI 绑定思路）；文档索引、根 README、`BACKLOG_EXPERIENCE_AND_ECOSYSTEM` 第三节与 **oclive-launcher** README 已链入。
