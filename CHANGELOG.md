...
- **文档**：[`creator-docs/distributions/KERNEL_AND_OOCP_RELEASE_PATH.md`](creator-docs/distributions/KERNEL_AND_OOCP_RELEASE_PATH.md)（crate DAG、版本策略、crates.io 顺序、Docker/桌面对齐、CI 门禁）；[`creator-docs/oocp/OOCP_SPEC_COMPLETE_REFERENCE.md`](creator-docs/oocp/OOCP_SPEC_COMPLETE_REFERENCE.md)（OOCP 实现级单一编排）；[`DOCUMENTATION_INDEX.md`](creator-docs/getting-started/DOCUMENTATION_INDEX.md)、[`KERNEL_SDK.md`](creator-docs/kernel/KERNEL_SDK.md)、[`OOCP_SPEC_v0_1.md`](creator-docs/oocp/OOCP_SPEC_v0_1.md)、[`OOCP_TRANSPORTS.md`](creator-docs/oocp/OOCP_TRANSPORTS.md)、[`DISTRIBUTION_DEV_GUIDE.md`](creator-docs/distributions/DISTRIBUTION_DEV_GUIDE.md)、[`ENGINEERING_ROADMAP_KERNEL_DEEPSEEK.md`](handoff/ENGINEERING_ROADMAP_KERNEL_DEEPSEEK.md) 交叉引用已更新。
