...
- **五仓工程卫生（Cursor 工作台扫描）**：[`docs/WORKSPACE_OPTIMIZATION_REPORT.md`](docs/WORKSPACE_OPTIMIZATION_REPORT.md)（24 项 + 分阶段计划；与 [`handoff/TECHNICAL_DEBT_INVENTORY.md`](handoff/TECHNICAL_DEBT_INVENTORY.md)、[`handoff/ARCHITECTURE_LAYERING.md`](handoff/ARCHITECTURE_LAYERING.md)「Cursor 优化轮」互补，执行前先查对接表）。
