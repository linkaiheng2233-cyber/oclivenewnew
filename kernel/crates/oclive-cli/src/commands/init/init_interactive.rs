...
use super::init_config::{
    apply_backend_cli_overrides, apply_cargo_metadata_cli, apply_monolith_options,
    apply_template_layer, ensure_cargo_license_default, pick_role_pack_kind, preset_config,
    quick_project_config, ProjectConfig, ProjectType, ProjectTypeArg, RolePackKind,
};
use super::InitArgs;
use crate::generator;
...
pub fn build_init_config(args: &InitArgs, skip_interactive_confirm: bool) -> Result<ProjectConfig> {
    if args.quick {
