...
<template>
  <div class="psp-root">
    ...
    <template v-else-if="panelSlots.length > 0">
      <div class="psp-tabs" role="tablist" :aria-label="String(t('pluginSettingsPanelSlots.tabsAria'))">
        <button
    ...
    <p v-else class="psp-msg psp-msg--muted">{{ t("pluginSettingsPanelSlots.empty") }}</p>
  </div>
</template>
