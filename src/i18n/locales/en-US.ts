export const enUS = {
  ...
  expertModels: {
    ...
    oclexpert: {
      ...
      publishRecipe: "Publish personality recipe",
      publishRecipeShortHint: "Open the guided publish flow (Issue / manual export / optional GitHub API).",
      browseRecipes: "Browse community personality recipe index",
      publishWizard: {
        title: "Publish personality recipe",
        step1Title: "Step 1: refine metadata",
        step2Title: "Step 2: preview & confirm",
        step3Title: "Step 3: choose how to publish",
        stepDoneTitle: "Done",
        issueBodyHead: "## OCLive personality recipe (oclexpert)",
        issueBodyClipboard:
          "The full `.oclexpert` JSON is **already in your system clipboard**. When submitting the issue: create a gist with that content, or save the clipboard to a `.oclexpert` file and attach it to the issue.",
        lastExportHint: "(Last export path on disk, if any)",
        clipboardFailed: "Could not write to the clipboard. Check app permissions.",
        clipboardOkToast: "Recipe JSON copied to clipboard.",
        copiedToast: "Copied to clipboard.",
        methodIssueTitle: "One-click GitHub Issue",
        methodIssueDesc:
          "Copies the full .oclexpert JSON to the clipboard and opens a pre-filled “new issue” page in your browser.",
        methodIssueGo: "Copy JSON & open Issue",
        methodManualTitle: "Export locally & publish manually",
        methodManualDesc:
          "Saves the recipe as a local .oclexpert file and opens the community repo contributing guide so you can follow the manual submission steps.",
        methodManualGo: "Save file & open guide",
        methodApiTitle: "GitHub API publish (advanced)",
        methodApiDesc:
          "Uses a Personal Access Token from this device: creates a public gist with the recipe, then opens an issue in the target repo linking to that gist. The token needs `gist` plus `repo` (or `public_repo` for public repos).",
        tokenLabel: "GitHub Personal Access Token (PAT)",
        tokenPlaceholder: "ghp_… or github_pat_…",
        issueRepoLabel: "Issue repository (owner/repo)",
        rememberToken: "Remember token (stores in localStorage; do not use on shared PCs)",
        methodApiGo: "Publish via API (gist + issue)",
        apiSuccessToast: "Issue created via API (page opened).",
        previewFilename: "Output filename",
        previewJson: "Content preview (JSON)",
        previewTruncate: "Showing first {n} characters only",
        issueOpenedHint:
          "A pre-filled issue tab should be open. The full recipe JSON is on the clipboard—attach it as a file or gist as described in the issue body. After you submit, copy the real issue URL from the address bar for sharing.",
        manualDoneHint: "File saved and the contributing guide is open. You can share the file path or guide link with collaborators.",
        apiDoneHint: "A public gist and issue were created via the API; the issue page should be open.",
        doneDraftIssueLine: "Pre-filled issue URL (after you submit, prefer the real issue URL for sharing)",
        doneIssueLine: "Issue URL",
        donePrimaryPath: "Saved file path",
        copyPrimary: "Copy publish link / path",
        copyGistHint: "Recipe gist (raw JSON)",
        copyGistLink: "Copy gist URL",
        doneContributing: "Contributing guide",
        copySecondary: "Copy link",
        cancel: "Cancel",
        back: "Back",
        next: "Next",
        close: "Close",
        tokenMissing: "Please enter a GitHub token.",
        issueRepoInvalid: "Repository must look like owner/repo, e.g. linkaiheng2233-cyber/awesome-oclive-plugins.",
      },
      offerResetEffective:
