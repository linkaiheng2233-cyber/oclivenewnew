...
export default {
  ...
  theater: {
    ...
    outlineNew: '新建大纲',
    outlineAddBeat: '添加节拍',
    outlineCompile: '编译并播放',
    outlineExport: '导出大纲',
    outlineTitle: '场景标题',
    outlineBeatPlaceholder: '这一节拍发生什么…',
    outlineCompiled: '已编译，切换到微调模式播放',
    improvHint: '三向演绎：你插话 → 小焦 → 阿懒（最多 {max} 轮，当前 {round}）',
    improvInputPlaceholder: '插一句话…',
    improvSend: '发送',
    improvReset: '重新开始',
    improvExportOutline: '导出大纲',
    improvFreeze: '冻结为骨架',
    improvGenerating: '角色思考中…',
    improvFallback: '本地模型不可用，已插入占位台词',
    improvLineOk: '{who} 已回应',
    improvDirectorLine: '{who} 已回应（导演插件）',
    improvDirectorWarn: '导演插件提示 {n} 条规则问题，仍已冻结骨架',
