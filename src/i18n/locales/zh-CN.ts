export const zhCN = {
  ...
  settings: {
    ...
    expertHub: {
      deepLinkFoot: "点击下方按钮将在设置中打开侧栏「专家模型工作台」并嵌入完整工作台。",
    ...
    systemHub: {
      pageLead:
        "按子域分组跳转常用高级页，减少在长侧栏中来回查找。依赖开发者总闸的项在总闸关闭时会提示先开启。",
      masterOffNote: "请先在设置窗顶部开启「设置中心开发者模式」，以打开下方链接所依赖的侧栏专页。",
      devToolsTitle: "开发工具",
      devToolsHint: "插件管理 V1/V2、市场、快捷键管理。",
      aiTitle: "AI 引擎",
      aiHint: "专家模型与云端 / 本机模型后端。",
      netTitle: "网络与权限",
      netHint: "强制 iframe 与市场索引源等。",
      diagTitle: "诊断与调试",
      diagHint: "调试嵌入与 Agent / MCP 说明页。",
      expTitle: "系统与实验",
      expHint: "内核实验开关与概览页的全局恢复默认。",
      linkShortcuts: "快捷键管理",
      linkPluginsInstalled: "已安装与市场 · 嵌入「插件」页",
      linkPluginsSlots: "界面插槽顺序 · 嵌入",
      linkPluginsV2: "V2 插件管理",
      linkMarket: "插件市场（经典）",
      linkMarketV2: "插件市场（V2）",
      linkExpertHub: "专家模型设置",
      linkExpertWorkbench: "专家模型工作台",
      linkModelsCloud: "云端模型与密钥",
      linkModelsOllama: "本机模型与 Ollama",
      linkSecurity: "安全与隐私",
      linkMarketDev: "市场开发者模式与索引源",
      linkDiag: "诊断与调试",
      linkAgent: "Agent / MCP 调试",
      linkExperimental: "内核与实验（V2 开关）",
      linkOverviewReset: "概览 · 全局恢复默认",
    },
    roleSettings: {
  ...
  pluginManager: {
    ...
    moreMenu: {
      ...
      tileHelpText: {
        ...
        v2:
          "顶栏「更多」仅保留快捷键说明与「设置」入口。插件管理 V2 与 V2 市场在设置内嵌（需开发者总闸与 V2 实验）；快捷键 {m}+Shift+S / F / A / D 跳转到对应设置页。",
      },
    },
    shortcuts: {
      ...
      ctrlShiftADescription:
        "打开设置「插件市场」：开发者总闸与 V2 实验均开启时进入嵌入版 V2 市场侧栏项；否则进入经典市场并嵌入。",
    },
  },
  rolePackBar: {
  ...
  expertModels: {
    ...
    oclexpert: {
      ...
      previewAuthor: "作者",
      previewGraphSummary: "节点概览",
      previewGraphEmpty: "（空图）",
      previewPrivacy: "隐私与数据影响",
      previewPrivacyBaseline: "导入仅在本地更新工作流草稿；不会自动上传文件。",
      previewPrivacyTriggers: "含事件触发器：应用至会话后，命中规则时可能写入长期记忆。",
      ...
      publishRecipe: "发布人格配方",
      publishRecipeShortHint: "打开引导式发布流程（Issue / 手动导出 / 可选 GitHub API）。",
      browseRecipes: "浏览社区人格配方索引",
      publishWizard: {
        title: "发布人格配方",
        step1Title: "第 1 步：完善信息",
        step2Title: "第 2 步：预览并确认",
        step3Title: "第 3 步：选择发布方式",
        stepDoneTitle: "完成",
        issueBodyHead: "## OCLive 人格配方（oclexpert）",
        issueBodyClipboard:
          "完整 `.oclexpert` JSON **已复制到系统剪贴板**。请在提交 Issue 时：新建一个 gist 上传该内容，或将剪贴板保存为 `.oclexpert` 文件后拖拽到 Issue 附件区。",
        lastExportHint: "（此前导出路径，仅供参考）",
        clipboardFailed: "无法写入剪贴板，请检查浏览器权限。",
        clipboardOkToast: "配方 JSON 已复制到剪贴板。",
        copiedToast: "已复制到剪贴板。",
        methodIssueTitle: "一键创建 GitHub Issue",
        methodIssueDesc: "将完整 .oclexpert JSON 复制到剪贴板，并在浏览器中打开已预填标题与正文的「新建 Issue」页面。",
        methodIssueGo: "复制 JSON 并打开 Issue",
        methodManualTitle: "手动导出并发布",
        methodManualDesc: "将配方保存为本地 .oclexpert 文件，并打开社区仓库的贡献说明页面，按文档手动提交。",
        methodManualGo: "保存文件并打开贡献指南",
        methodApiTitle: "GitHub API 发布（高级）",
        methodApiDesc:
          "在本机通过后端请求 GitHub：先创建公开 Gist 存放配方文件，再在目标仓库创建 Issue 并附上 Gist 链接。需要 Token 具备 `gist` 与目标仓库的 `repo`（或公开库的 `public_repo`）权限。",
        tokenLabel: "GitHub 个人访问令牌（PAT）",
        tokenPlaceholder: "ghp_… 或 github_pat_…",
        issueRepoLabel: "创建 Issue 的仓库（owner/repo）",
        rememberToken: "记住令牌（保存在本机 localStorage，请勿在共享电脑勾选）",
        methodApiGo: "通过 API 创建 Gist 与 Issue",
        apiSuccessToast: "已通过 API 创建 Issue（并打开页面）。",
        previewFilename: "将生成的文件名",
        previewJson: "内容预览（JSON）",
        previewTruncate: "仅显示前 {n} 个字符",
        issueOpenedHint:
          "已在浏览器打开预填 Issue。剪贴板中即为完整配方 JSON：请按正文说明上传为文件或 Gist。提交 Issue 后，请从浏览器地址栏复制正式 Issue 链接用于分享。",
        manualDoneHint: "已保存本地文件并打开贡献指南。可将文件路径或指南链接分享给协作者。",
        apiDoneHint: "已通过 API 创建公开 Gist 与 Issue，并已尝试打开 Issue 页面。",
        doneDraftIssueLine: "预填 Issue 链接（提交后请改用 Issue 页地址作为正式发布链接）",
        doneIssueLine: "Issue 链接",
        donePrimaryPath: "已保存文件路径",
        copyPrimary: "复制发布链接 / 路径",
        copyGistHint: "配方 Gist（JSON 原文）",
        copyGistLink: "复制 Gist 链接",
        doneContributing: "贡献指南",
        copySecondary: "复制链接",
        cancel: "取消",
        back: "上一步",
        next: "下一步",
        close: "关闭",
        tokenMissing: "请填写 GitHub Token。",
        issueRepoInvalid: "仓库需为 owner/repo 格式，例如 linkaiheng2233-cyber/awesome-oclive-plugins。",
      },
    ...
    inspector: {
      ...
      eventHint:
        "回合结束后按「匹配范围」扫描子串；命中则将记忆模板写入长期记忆（支持 {match} / {keyword} 占位符，与内核一致）。",
    ...
    eventTriggerWorkbench: {
      sectionCondition: "触发条件",
      sectionMemory: "记忆模板",
      sectionTest: "效果测试",
      scopeLabel: "匹配范围",
      scopeAny: "用户句或模型回复（其一包含关键词即可）",
      scopeUser: "仅用户消息",
      scopeBot: "仅模型回复",
      keywordLabel: "关键词（子串匹配，区分大小写）",
      memoryHint: "写入前会将占位符替换为上面填写的关键词文本：",
      placeholderTokens: "{match} 或 {keyword}",
      testUserLabel: "模拟用户消息",
      testUserPlaceholder: "输入一段用户话…",
      testBotLabel: "模拟模型回复（可选）",
      testBotPlaceholder: "若匹配范围包含模型回复，可在此填写…",
      testRun: "测试触发条件",
      testResultFires: "会触发",
      testResultNoFire: "不会触发",
      testResolved: "将写入的长期记忆预览",
      testHitUser: "命中：用户消息",
      testHitBot: "命中：模型回复",
      testReasonDisabled: "该节点已禁用。",
      testReasonEmptyKeyword: "关键词为空（内核会跳过）。",
      testReasonEmptyMemory: "记忆模板为空（内核会跳过）。",
      testReasonNoMatch: "在当前匹配范围内未命中子串。",
    },
    promptStyle: {
