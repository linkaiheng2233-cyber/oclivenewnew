...
| **T14–T20** (`official-vue-test-runner`, etc.) | Editor-built capability, wired to the workspace as a **directory plugin** pattern; **T14 Vue runner** is in-repo at `plugins/official-vue-test-runner/` (see plugin README). |
