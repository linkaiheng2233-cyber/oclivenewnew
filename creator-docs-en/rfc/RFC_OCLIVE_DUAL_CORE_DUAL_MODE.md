...
**Progress**: P0 docs only; P1–P5 not started. See [DUAL_CORE_CURSOR_HANDOFF.md](../../handoff/DUAL_CORE_CURSOR_HANDOFF.md).

Current delivery stays on **v2 single stable path** until RFC phases P1+ are approved.
