...
| **Kernel factory (`doctor`, `--quick`, bench v2, 5-min walkthrough)** | **[KERNEL_FACTORY_VISION.md](KERNEL_FACTORY_VISION.md)** (Chinese: [../../creator-docs/getting-started/KERNEL_FACTORY_VISION.md](../../creator-docs/getting-started/KERNEL_FACTORY_VISION.md)) |
