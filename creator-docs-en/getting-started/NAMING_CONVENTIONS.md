...
4. **Kernel crates** are **not** renamed in v0.2.x — see [crates/README.md](../../crates/README.md).
...
8. **Orchestration path**: `crates/oclive_kernel_host/src/domain/chat_engine/process_message.rs` — **not** `src-tauri/src/domain/` (legacy).
