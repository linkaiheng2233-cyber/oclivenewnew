...
- **Role pack blueprint v2 (P0–P8)**: `pipeline.ocblueprint` is the recommended SSOT; **`pack validate` defaults to v2**; golden pack `roles/mumu`; architecture graph **`save_role_slot_registry`**. See [BLUEPRINT_V2_IMPLEMENTATION_PLAN.md](../../handoff/BLUEPRINT_V2_IMPLEMENTATION_PLAN.md).
